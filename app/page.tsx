...
const Home: React.FC = () => {
  ...
  My journey—from legacy systems to cutting-edge cloud technologies—demonstrates my ability to adapt, innovate, and drive digital transformation. I am dedicated to leveraging my diverse experience to create scalable, efficient solutions that empower businesses to thrive in the digital-first world.
    </p>
  </div>
</section>
